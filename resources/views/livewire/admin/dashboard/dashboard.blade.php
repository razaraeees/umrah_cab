                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="avatar-sm">
                                                        <span class="avatar-title rounded bg-light">
                                                            <img src="{{ asset('assets/images/product/img-11.png') }}" class="avatar-sm" alt="Error">
                                                        </span>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="avatar-sm">
                                                        <span class="avatar-title rounded bg-light">
                                                            <img src="{{ asset('assets/images/product/img-9.png') }}" class="avatar-sm" alt="Error">
                                                        </span>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="avatar-sm">
                                                        <span class="avatar-title rounded bg-light">
                                                            <img src="{{ asset('assets/images/product/img-1.png') }}" class="avatar-sm" alt="Error">
                                                        </span>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="avatar-sm">
                                                        <span class="avatar-title rounded bg-light">
                                                            <img src="{{ asset('assets/images/product/img-4.png') }}" class="avatar-sm" alt="Error">
                                                        </span>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="avatar-sm">
                                                        <span class="avatar-title rounded bg-light">
                                                            <img src="{{ asset('assets/images/product/img-3.png') }}" class="avatar-sm" alt="Error">
                                                        </span>
                                                    </div>
                                                </td>
                                                <td>
